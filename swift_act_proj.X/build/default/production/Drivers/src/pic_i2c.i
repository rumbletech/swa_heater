...
# 2 "<built-in>" 2
# 1 "Drivers/src/pic_i2c.c" 2
# 22 "Drivers/src/pic_i2c.c"
# 1 "Drivers/src/../incl/pic_i2c.h" 1
# 20 "Drivers/src/../incl/pic_i2c.h"
...
# 22 "Drivers/src/pic_i2c.c" 2
# 34 "Drivers/src/pic_i2c.c"
int8_t I2C_Init ( I2C_Config_S* i2ch )
{
    ...
    if ( i2ch->I2C_mode == I2C_MODE_MASTER_HARDWARE_CONTROLLED )
    {
        ...
        SSPADD = (( (8000000UL / 4 )/( i2ch->I2C_freq ) ) -1 );
    ...
    SSPCON2 = 0x00;
    SSPSTAT = 0x00;
    SSPCON = (( i2ch->I2C_mode << 0x0 )|( 1 << 0x5 )) ;
...
void I2C_Halt ( void )
{
    while ( (SSPSTAT&( 1 << 0x2)) || ( SSPCON2 & (0x10 | 0x1 | 0x2 | 0x8 | 0x4)) );
}
