...
# 2 "<built-in>" 2
# 1 "Drivers/src/pic_adc.c" 2
# 18 "Drivers/src/pic_adc.c"
# 1 "Drivers/src/../incl/pic_adc.h" 1
# 21 "Drivers/src/../incl/pic_adc.h"
...
# 21 "Drivers/src/../incl/../../config/../Drivers/incl/eep.h"
# 1 "Drivers/src/../incl/../../config/pconfig.h" 1
...
# 115 "Drivers/src/pic_adc.c"
int8_t ADC_Init ( ADC_Config_S * config_s_ptr )
{



    if ( (config_s_ptr->CH_sel > (8UL -1 ) ) ||
    ...
    ADCON1 = ( (config_s_ptr->FMT_bf << 0x7 ) |
               (config_s_ptr->PCFG_bf << 0x0 )|
               ((config_s_ptr->CKSEL_bf >> 2 ) << 0x6) );
    ...
    ADCON0 = ( (config_s_ptr->CH_sel << 0x3 ) |
                ((config_s_ptr->CKSEL_bf&4) << 0x6) |
                ( 1 << 0x0 ) );
