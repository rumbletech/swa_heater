...
# 1 "Drivers/src/../incl/pic_tim1.h" 1
# 21 "Drivers/src/../incl/pic_tim1.h"
...
# 7 "Drivers/src/pic_tim1.c" 2
# 21 "Drivers/src/pic_tim1.c"
void TIM1_Init ( void )
{
...
int8_t DisplayInit( void )
{
    ...
    TRISA &= ~ ( 1 << 5 );
    TRISA &= ~ ( 1 << 4 );
    T2CON&= ~ ( 1 << 0x2 ); PORTA &= ~( 1 << 5 ); PORTA &= ~ ( 1 << 4 );
