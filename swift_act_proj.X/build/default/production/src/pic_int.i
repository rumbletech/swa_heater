...
typedef enum {
    ...
    ADC_CKSEL_FOSC_DIV2 = 0B000 ,
    ADC_CKSEL_FOSC_DIV8 = 0B001 ,
    ADC_CKSEL_FOSC_DIV32 = 0B010 ,
    ADC_CKSEL_FOSC_RC = 0B011 ,
    ADC_CKSEL_FOSC_DIV4 = 0B100 ,
    ADC_CKSEL_FOSC_DIV16 = 0B101 ,
    ADC_CKSEL_FOSC_DIV64 = 0B110 ,
...
typedef enum {
    ...
    ADC_PCFG_CR_80 = 0B0000 ,
    ADC_PCFG_CR_71 = 0B0001 ,
    ADC_PCFG_CR_50 = 0B0010 ,
    ADC_PCFG_CR_41 = 0B0011 ,
    ADC_PCFG_CR_30 = 0B0100 ,
    ADC_PCFG_CR_21 = 0B0101 ,
    ADC_PCFG_CR_00 = 0B0110 ,
    ADC_PCFG_CR_62 = 0B1000 ,
    ADC_PCFG_CR_60 = 0B1001 ,
    ADC_PCFG_CR_51 = 0B1010 ,
    ADC_PCFG_CR_42 = 0B1011 ,
    ADC_PCFG_CR_32 = 0B1100 ,
    ADC_PCFG_CR_22 = 0B1101 ,
    ADC_PCFG_CR_10 = 0B1110 ,
    ADC_PCFG_CR_12 = 0B1111 ,
...
typedef struct {
   ...
   ADC_CKSEL_ET CKSEL_bf ;

   ADC_PCFG_ET PCFG_bf ;

   ADC_FMTSEL_ET FMT_bf ;
...
typedef enum
{
    I2C_MODE_SLAVE_ADDR10_INTEN = 0B1111 ,
    I2C_MODE_SLAVE_ADDR7_INTEN = 0B1110 ,
    I2C_MODE_MASTER_FIRMWARE_CONTROLLED = 0B1011 ,
    I2C_MODE_MASTER_HARDWARE_CONTROLLED = 0B1000 ,
    I2C_MODE_SLAVE_ADDR10 = 0B0111 ,
    I2C_MODE_SLAVE_ADDR7 = 0B0110 ,
...
volatile uint16_t average_temp = 35 ;
volatile uint8_t heater_state = 0 ;
volatile uint8_t cooler_state = 0 ;
...
void TIMER2_IRQ_Handler( void )
{
    ...
    if ( display_state == 1 && device_state == 1 ){
    if ( !digit ){
...
void TIMER1_IRQ_Handler( void )
{
    ...
    if ( !(PORTB & ( 1 << last_clicked_button )) && last_clicked_button != 0 )
    {
    ...
    if ( device_state == 1 && display_state == 1 ) {
        if ( display_mode == 1 )
        {
    ...
    if ( (++sig_blink_count) >= 30 && display_mode == 2 )
    {
...
void ADC_IRQ_Handler ( void )
{
    ...
    if ( device_state == 1 ){
    if ( desired_temp > average_temp && ( desired_temp - average_temp ) > 5 && heater_state == 0 && cooler_state == 0 ){

            PORTC |= ( 1 << 5 );heater_state = 1;heat_led_count= 0 ;

        }
    else if ( desired_temp < average_temp && ( average_temp - desired_temp ) > 5 && cooler_state == 0 && heater_state == 0 )
        {
